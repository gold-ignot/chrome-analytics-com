...
export default function AdvancedAnalyticsCards({ extension, timeframe }: AdvancedAnalyticsCardsProps) {
  ...
  const renderCard = (
    ...
    <div className={`${colorClasses.bg} rounded-lg ${colorClasses.border} p-5 relative group hover:shadow-lg transition-all duration-300 cursor-help`}>
      ...
      <div className="absolute bottom-full mb-2 left-0 right-0 bg-white border border-gray-200 text-gray-800 text-sm rounded-lg px-3 py-2 opacity-0 group-hover:opacity-100 transition-all duration-200 pointer-events-none z-[9999] shadow-lg whitespace-normal">
