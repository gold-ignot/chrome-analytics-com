    ...
    <div className="bg-slate-50 min-h-screen">
      ...
      <section className="py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* Screenshots Gallery - Mobile-Optimized Carousel */}
            ...
            <div className="bg-white rounded-lg border border-gray-200 p-4 sm:p-6 mb-8">
              <div className="flex items-center justify-between mb-4">
                ...
                <span className="text-sm text-gray-500">
                  {currentScreenshot + 1} of {extension.screenshots.length}
                </span>
              </div>
              ...
              <div className="relative">
                ...
                <div className="relative aspect-video bg-gray-100 rounded-lg overflow-hidden">
                  <img
                    src={extension.screenshots[currentScreenshot]}
                    alt={`${extension.name} screenshot ${currentScreenshot + 1}`}
                    className="w-full h-full object-contain cursor-pointer"
                    onClick={() => window.open(extension.screenshots[currentScreenshot], '_blank')}
                  />
                  ...
                  {extension.screenshots.length > 1 && (
                    <>
                      <button
                        onClick={() => setCurrentScreenshot(prev => prev === 0 ? extension.screenshots!.length - 1 : prev - 1)}
                        ...
                        disabled={extension.screenshots.length <= 1}
                      >
                      ...
                      <button
                        onClick={() => setCurrentScreenshot(prev => prev === extension.screenshots!.length - 1 ? 0 : prev + 1)}
            ...
            <div className="prose max-w-none">
              <div className="text-gray-700 leading-relaxed whitespace-pre-line">
                {extension.full_description ? (
                  showFullDescription || extension.full_description.length <= 500 ? (
                    <>
                      {extension.full_description}
                      {extension.full_description.length > 500 && (
                        <button
                    ...
                    <>
                      {extension.full_description.substring(0, 500)}...
                      <button
